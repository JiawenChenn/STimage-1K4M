---
layout: article
title: Fine-tune CLIP image encoder
sidebar:
  nav: document_nav
permalink: docs/05_clip_human_brain_DLPFC
---

This document includes code for fine-tuning CLIP model on human DLPFC data. This code is adopted from [CLIP repository](https://github.com/openai/CLIP/issues/83). You need to download [model_st.py](doc_data/model_st.py) and load essential functions.
...
st_model = ST_contrastive_model(gene_expression_data.shape[1],32,vision_model)
