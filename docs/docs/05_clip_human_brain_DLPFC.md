...
This document includes code for fine-tuning CLIP model on human DLPFC data. This code is adopted from [CLIP repository](https://github.com/openai/CLIP/issues/83).
