...
GEO_visium['species'] = GEO_visium['species'].replace({'Mus musculus':'mouse','Homo sapiens':'human','Medicago truncatula':'plant',
...
# any of 'cancer' 'tumor' 'metastasis' in chara or tissue or Extraction_protocol or title or abstract or keywords
...
meta.to_csv('./meta/meta_all_gene.csv',index=False,sep=',',quoting=1)